...
import { getIPCField } from "../../utils/getIPCField";
...
export default function PatentList({
  ...
  const [selectedPatent, setSelectedPatent] = useState<PatentListItem | null>(
    null
  );
            ...
            {displayPatents.map((patent) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    <div className="font-medium">{ipcInfo.field}</div>
                    <div className="text-gray-500 text-xs">{ipcInfo.code}</div>
                  </td>
